...
class TargetSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('SIAPI\Component\Resource\JsonCollection\Query\Data\Target');
    ...
    {
        $this->getList()->shouldReturnAnInstanceOf('SIAPI\Component\Resource\JsonCollection\Query\ListData\Target');
    }
}
